...
export const experience = [
  { role: 'Especialista en Desarrollo de Software', company: 'UNIDAD DE COORDINACIÓN DE PROYECTOS DEL PODER JUDICIAL', date: 'Dic. 2024 - Jun. 2025', description: 'Desarrollo de microservicios utilizando Java 21, Spring Boot y JPA. Implementación de librerías abstractas reutilizables (Outbox, MQAL, CDC y mecanismos de resiliencia como Circuit Breaker, Retry, Bulkhead, Timeout, Fallback).' },
  { role: 'Especialista en Desarrollo de Software', company: 'MINISTERIO PÚBLICO FISCALÍA DE LA NACIÓN', date: 'Nov. 2020 - Nov. 2024', description: 'Implementación de sistema de consulta con reconocimiento biométrico y arquitectura de seguridad. Modernización de interfaces de la Junta de fiscales supremos. Desarrollo de la plataforma de Ciberdelincuencia.' },
  ...
  { role: 'Especialista en Desarrollo de Software', company: 'DISLAC S.R.L.', date: 'Jul. 2017 - Nov. 2020', description: 'Desarrollo y mantenimiento de software, análisis de requerimientos y soporte técnico.' },
